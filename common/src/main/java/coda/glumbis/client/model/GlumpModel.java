...
public class GlumpModel extends AnimatedGeoModel<GlumpEntity> {
    ...
    @Override
    public ResourceLocation getModelResource(GlumpEntity object) {
        return new ResourceLocation(Glumbis.MOD_ID, "geo/entity/glump.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(GlumpEntity object) {
    ...
    @Override
    public ResourceLocation getAnimationResource(GlumpEntity animatable) {
