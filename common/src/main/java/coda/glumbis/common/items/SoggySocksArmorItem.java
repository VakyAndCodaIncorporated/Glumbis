...
public class SoggySocksArmorItem extends ArmorItem implements IArmorTick {
    public static final ArmorMaterial MATERIAL = new SockArmorMaterial(Glumbis.MOD_ID + "_soggy_socks", 2, new int[]{2, 3, 3, 2}, 9, SoundEvents.GENERIC_SPLASH, 0.0F, () -> Ingredient.of(Items.STRING));
