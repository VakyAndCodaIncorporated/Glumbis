...
public class GlumbisEntities {
    ...
    public static final RegistryObject<EntityType<BigSockEntity>> BIG_SOCK = create("big_sock", EntityType.Builder.<BigSockEntity>of(BigSockEntity::new, MobCategory.MISC).sized(1.5f, 2.0f));
