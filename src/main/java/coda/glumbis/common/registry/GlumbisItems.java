...
public class GlumbisItems {
    ...
    public static final RegistryObject<Item> ROTTEN_EGG_SPAWN_EGG = ITEMS.register("rotten_egg_spawn_egg", () -> new ForgeSpawnEggItem(GlumbisEntities.GLUMBOSS, 0xfbfcfc, 0xfff167, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final RegistryObject<Item> BIG_SOCK = ITEMS.register("big_sock", () -> new BigSockItem(new Item.Properties().tab(Glumbis.GROUP).stacksTo(1).rarity(Rarity.EPIC)));
