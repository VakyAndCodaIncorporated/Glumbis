...
public class GlumbisItems {
    ...
    public static final RegistryObject<Item> GLUMBOSS_SPAWN_EGG = ITEMS.register("glumboss_spawn_egg", () -> new ForgeSpawnEggItem(GlumbisEntities.GLUMBOSS, 0xfbfcfc, 0xfff167, new Item.Properties().tab(Glumbis.GROUP)));
