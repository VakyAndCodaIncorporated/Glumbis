...
public class GlumbisItems {
    ...
    public static final RegistryObject<Item> GLUMBO = ITEMS.register("glumbo", () -> new BowlFoodItem(new Item.Properties().tab(Glumbis.GROUP).rarity(Rarity.RARE).food(new FoodProperties.Builder().saturationMod(1.0F).nutrition(12).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 200, 0), 1.0F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 300, 0), 1.0F).effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 400, 0), 1.0F).alwaysEat().build()).stacksTo(1)));
