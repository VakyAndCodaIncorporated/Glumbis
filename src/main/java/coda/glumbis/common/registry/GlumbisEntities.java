...
public class GlumbisEntities {
    ...
    public static final RegistryObject<EntityType<GlumbossEntity>> GLUMBOSS = create("glumboss", EntityType.Builder.of(GlumbossEntity::new, MobCategory.CREATURE).sized(1.5f, 2.95f).fireImmune());
    ...
    public static final RegistryObject<EntityType<RocketPropelledGlumpEntity>> ROCKET_PROPELLED_GLUMP = create("rocket_propelled_glump",EntityType.Builder.<RocketPropelledGlumpEntity>of(RocketPropelledGlumpEntity::new, MobCategory.MISC).sized(0.25f, 0.25f));
