...
public class RocketPropelledGlumpModel extends AnimatedGeoModel<RocketPropelledGlumpEntity> {
    ...
    @Override
    public ResourceLocation getModelLocation(RocketPropelledGlumpEntity object) {
        return new ResourceLocation(Glumbis.MOD_ID, "geo/entity/glump.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(RocketPropelledGlumpEntity object) {
    ...
    @Override
    public ResourceLocation getAnimationFileLocation(RocketPropelledGlumpEntity animatable) {
    ...
    public void setLivingAnimations(RocketPropelledGlumpEntity entity, Integer uniqueID, AnimationEvent customPredicate) {
        ...
        if (entity.tickCount % 10 == 0) {
            ...
            root.setScaleZ(root.getScaleZ() + random.nextFloat() / 10);
